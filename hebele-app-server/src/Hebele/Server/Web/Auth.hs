...
module Hebele.Server.Web.Auth where
...
import Hebele.Server.Internal.Algebra (MonadUser (authenticate))
import Hebele.Server.Internal.HebeleM (Env, runHebeleM)
...
type instance Auth.AuthServerData (Servant.AuthProtect "hebele-auth") = Types.User
